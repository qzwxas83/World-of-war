...
class Drawing:
    def __init__(self, sc, sc_map, player, clock):
        ...
        self.font_win = pygame.font.Font('font/font.ttf', 182)
    ...
    def win(self):
        ...
        rect = pygame.Rect(0, 0, 1290, 230)
        rect.center = HALF_WIDTH, HALF_HEIGHT
        pygame.draw.rect(self.sc, BLACK, rect, border_radius=50)
        self.sc.blit(render, (rect.centerx - 520, rect.centery - 110))
        pygame.display.flip()
        self.clock.tick(15)
    ...
    def menu(self):
        ...
        x = 0
        button_font = pygame.font.Font('font/font.ttf', 80)
        label_font = pygame.font.Font('font/font1.otf', 325)
        start = button_font.render('START', 1, pygame.Color('lightgray'))
        button_start = pygame.Rect(0, 0, 420, 150)
        button_start.center = HALF_WIDTH, HALF_HEIGHT
        exit = button_font.render('EXIT', 1, pygame.Color('lightgray'))
        button_exit = pygame.Rect(0, 0, 360, 150)
        ...
        while self.menu_trigger:
            ...
            self.sc.blit(start, (button_start.centerx - 150, button_start.centery - 50))

            pygame.draw.rect(self.sc, BLACK, button_exit, border_radius=25, width=10)
            self.sc.blit(exit, (button_exit.centerx - 95, button_exit.centery - 50))

            color = randrange(40)
            label = label_font.render('World of War', 1, (color, color, color))
